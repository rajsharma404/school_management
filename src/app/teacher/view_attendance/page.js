...
import style from "./teacher_view_attendance_marking.module.css";
...
const Page = () => {
    ...
    useEffect(() => {
        const fetchAttendanceData = async () => {
            ...
            try {
                const response = await fetch(`http://localhost:3000/api/teacher_attendance_marking?month=${currentMonth + 1}&year=${currentYear}`);
                if (!response.ok) {
